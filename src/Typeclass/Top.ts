...
export interface Top2<T extends HKT2> {
  readonly top: Kind2<T, InitialOf<T, Params.E>, unknown>
}
...
export interface Top3<T extends HKT3> {
  readonly top: Kind3<T, InitialOf<T, Params.R>, InitialOf<T, Params.E>, unknown>
}

export interface Top3RC<T extends HKT3, R> {
  readonly top: Kind3<T, R, InitialOf<T, Params.E>, unknown>
}
...
export interface Top3EC<T extends HKT3, E> {
  readonly top: Kind3<T, InitialOf<T, Params.R>, E, unknown>
}
...
export interface Top4SC<T extends HKT4, S> {
  readonly top: Kind4<T, S, InitialOf<T, Params.R>, InitialOf<T, Params.E>, unknown>
}

export interface Top4SRC<T extends HKT4, S, R> {
  readonly top: Kind4<T, S, R, InitialOf<T, Params.E>, unknown>
}

export interface Top4RC<T extends HKT4, R> {
  readonly top: Kind4<T, InitialOf<T, Params.S>, R, InitialOf<T, Params.E>, unknown>
}

export interface Top4SEC<T extends HKT4, S, E> {
  readonly top: Kind4<T, S, InitialOf<T, Params.R>, E, unknown>
}

export interface Top4REC<T extends HKT4, R, E> {
  readonly top: Kind4<T, InitialOf<T, Params.S>, R, E, unknown>
}

export interface Top4EC<T extends HKT4, E> {
  readonly top: Kind4<T, InitialOf<T, Params.S>, InitialOf<T, Params.R>, E, unknown>
}
...
export function makeFromValue<T extends HKT10>(
  ...
  A,
  Z = InitialOf<T, Params.Z>,
  Y = InitialOf<T, Params.Y>,
  X = InitialOf<T, Params.X>,
  W = InitialOf<T, Params.W>,
  V = InitialOf<T, Params.V>,
  U = InitialOf<T, Params.U>,
  S = InitialOf<T, Params.S>,
  R = InitialOf<T, Params.R>,
  E = InitialOf<T, Params.E>,
>(
  a: A,
...
): <A, S = InitialOf<T, Params.S>, R = InitialOf<T, Params.R>, E = InitialOf<T, Params.E>>(
  a: A,
) => Kind4<T, S, R, E, A>

export function makeFromValue<T extends HKT3>(
  T: Top3<T> & Covariant3<T>,
): <A, R = InitialOf<T, Params.R>, E = InitialOf<T, Params.E>>(a: A) => Kind3<T, R, E, A>

export function makeFromValue<T extends HKT2>(
  T: Top2<T> & Covariant2<T>,
): <A, E = InitialOf<T, Params.E>>(a: A) => Kind2<T, E, A>
...
export function makeFromLazy<T extends HKT3>(
  T: Top3<T> & Covariant3<T>,
): <A, R = InitialOf<T, Params.R>, E = InitialOf<T, Params.E>>(f: Lazy<A>) => Kind3<T, R, E, A>

export function makeFromLazy<T extends HKT2>(
  T: Top2<T> & Covariant2<T>,
): <A, E = InitialOf<T, Params.E>>(f: Lazy<A>) => Kind2<T, E, A>
...
export function top<F extends HKT10, G extends HKT4, E2>(
  ...
  InitialOf<F, Params.R>,
  InitialOf<F, Params.E>,
  Kind4<G, InitialOf<G, Params.S>, InitialOf<G, Params.R>, InitialOf<G, Params.E>, unknown>
>
...
export function top<F extends HKT10, G extends HKT3, E2>(
  ...
  InitialOf<F, Params.R>,
  InitialOf<F, Params.E>,
  Kind3<G, InitialOf<G, Params.R>, InitialOf<G, Params.E>, unknown>
>
...
export function top<F extends HKT, G extends HKT3, E2>(
  F: Top1<F> & Covariant1<F>,
  G: Top3EC<G, E2>,
): Kind<F, Kind3<G, InitialOf<G, Params.R>, InitialOf<G, Params.E>, unknown>>
...
export function top<F extends HKT10, G extends HKT2, E2>(
  ...
  InitialOf<F, Params.R>,
  InitialOf<F, Params.E>,
  Kind2<G, InitialOf<G, Params.E>, unknown>
>
...
export function top<F extends HKT2, E1, G extends HKT2, E2>(
  F: Top2EC<F, E1> & Covariant2EC<F, E1>,
  G: Top2EC<G, E2>,
): Kind2<F, InitialOf<F, Params.E>, Kind2<G, InitialOf<G, Params.E>, unknown>>
...
export function top<F extends HKT, G extends HKT2, E2>(
  F: Top1<F> & Covariant1<F>,
  G: Top2EC<G, E2>,
): Kind<F, Kind2<G, InitialOf<G, Params.E>, unknown>>
...
export function top<F extends HKT3, E1, G extends HKT>(
  F: Top3EC<F, E1> & Covariant3EC<F, E1>,
  G: Top1<G>,
): Kind3<F, InitialOf<F, Params.R>, InitialOf<F, Params.E>, Kind<G, unknown>>
...
export function top<F extends HKT2, E1, G extends HKT>(
  F: Top2EC<F, E1> & Covariant2EC<F, E1>,
  G: Top1<G>,
): Kind2<F, InitialOf<F, Params.E>, Kind<G, unknown>>
