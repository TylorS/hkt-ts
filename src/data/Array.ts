...
import { Compact1 } from '../Typeclass/effect/Compact'
...
import * as FilterMI from '../Typeclass/effect/FilterMapWithIndex'
import * as FM from '../Typeclass/effect/FoldMap'
import * as FMWI from '../Typeclass/effect/FoldMapWithIndex'
import * as FE from '../Typeclass/effect/ForEach'
import { ForEachWithIndex1 } from '../Typeclass/effect/ForEachWithIndex'
...
import * as PMI from '../Typeclass/effect/PartitionMapWithIndex'
import { Reduce1 } from '../Typeclass/effect/Reduce'
import { ReduceRight1 } from '../Typeclass/effect/ReduceRight'
import * as RRI from '../Typeclass/effect/ReduceRightWithIndex'
import * as RI from '../Typeclass/effect/ReduceWithIndex'
