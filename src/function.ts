...
/**
 * A function which will always throw
 */
export function absurd<A>(): A {
  throw new Error(
    // eslint-disable-next-line prefer-rest-params
    `Absurd! You called with ${Array.from(arguments)
...
/**
 * Type-level helper that extracts the function arguments out of a Function type.
 */
...
/**
 * Constant allows you to create a function which will constantly return the same value each time it
 * is called.
 */
export const constant =
  <A>(a: A) =>
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  (..._args: readonly unknown[]): A =>
    a
...
/**
 * The identity function simply returns the first value passed to it.
 */
...
export const tupled = <A>(a: A) => [a] as const
